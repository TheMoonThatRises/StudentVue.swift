...
struct GradingPeriod: XMLObjectDeserialization {
    var index: Int?
    var gradePeriodName: String
    var startDate: Date
    var endDate: Date

    static func deserialize(_ element: XMLIndexer) throws -> GradingPeriod {
...
struct GradeBookResource: XMLObjectDeserialization {
    var classID: String
    var fileType: String?
    ...
    static func deserialize(_ element: XMLIndexer) throws -> GradeBookResource {
...
struct GradeBookAssignment: XMLObjectDeserialization {
    ...
    static func deserialize(_ element: XMLIndexer) throws -> GradeBookAssignment {
...
struct Grade: XMLObjectDeserialization {
    var gradePeriodName: String
    var calculatedGrade: String
    var calculatedGradeRaw: Float
    var assignments: [GradeBookAssignment]

    static func deserialize(_ element: XMLIndexer) throws -> Grade {
...
struct Course: XMLObjectDeserialization {
    ...
    static func deserialize(_ element: XMLIndexer) throws -> Course {
...
struct GradeBook: XMLObjectDeserialization {
    var gradingPeriods: [GradingPeriod]
    var cuarrentGradingPeriod: GradingPeriod
    var courses: [Course]

    static func deserialize(_ element: XMLIndexer) throws -> GradeBook {
