...
struct MessageListing: XMLObjectDeserialization {
    var iconURL: String?
    var id: String?
    var beginDate: Date
    var type: String
    ...
    static func deserialize(_ element: XMLIndexer) throws -> MessageListing {
...
struct SynergyMessageListingByStudent: XMLObjectDeserialization {
    var studentGU: String
    var messageListings: [MessageListing]

    static func deserialize(_ element: XMLIndexer) throws -> SynergyMessageListingByStudent {
...
struct PXPMessages: XMLObjectDeserialization {
    var messageListings: [MessageListing]
    var synergyMessageListingsByStudents: [SynergyMessageListingByStudent]

    static func deserialize(_ element: XMLIndexer) throws -> PXPMessages {
