...
struct EmergencyContact: XMLObjectDeserialization {
    var name: String
    ...
    static func deserialize(_ element: XMLIndexer) throws -> EmergencyContact {
...
struct PhysicianInfo: XMLObjectDeserialization {
    var name: String
    var hospital: String
    var phone: String
    var extn: String

    static func deserialize(_ element: XMLIndexer) throws -> PhysicianInfo {
...
struct DentistInfo: XMLObjectDeserialization {
    var name: String
    var office: String
    var phone: String
    var extn: String

    static func deserialize(_ element: XMLIndexer) throws -> DentistInfo {
...
struct UserDefinedItem: XMLObjectDeserialization {
    ...
    static func deserialize(_ element: XMLIndexer) throws -> UserDefinedItem {
...
struct StudentInfo: XMLObjectDeserialization {
    ...
    static func deserialize(_ element: XMLIndexer) throws -> StudentInfo {
